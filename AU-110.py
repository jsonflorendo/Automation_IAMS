...
try:
    ...
    intro_textarea = wait.until(EC.presence_of_element_located((By.ID, "aud_objectives_intro")))
    intro_textarea.clear()
    intro_textarea.send_keys("THIS IS SAMPLE INTRODUCTION ONLY")
