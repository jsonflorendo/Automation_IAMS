from Library_Tab.Agency_Tab.Agency_input import Agency
import time
...
try:
    ...
    element = WebDriverWait(driver, 10).until(EC.visibility_of_element_located((By.XPATH, "//h4[normalize-space()='Library']")))

    # Get the text content of the element
    actual_text = element.text.strip()

    # Define the expected text
    expected_text = "Library"
    ...
    print("Text assertion passed: Library")
...
# Find the icon element
icon = WebDriverWait(driver, 10).until(EC.visibility_of_element_located((By.XPATH, "//h4[normalize-space()='Library']")))
...
agency_instance.add_agency()  # Call the add_agency method
