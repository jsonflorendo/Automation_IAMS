...
class Areacomplete:
    ...
    def execute(self):
        ...
        try:
            ...
            ok_button = WebDriverWait(driver, 10).until(EC.visibility_of_element_located((By.CSS_SELECTOR, "button[class='swal2-confirm swal2-styled']")))
            ok_button.click()

if"__main__" == __name__:
    aa_message_instance = Areacomplete()
    aa_message_instance.execute()